...
- **Middle Ring:** APC execution efficiency. ⚙️
...
- **Interaction:** 
    ...
    - Zoom into an APC node -> Rings change to show **APC Sandbox Metrics** (CPU/RAM/IO). ⚙️
