...
*   **`cmd`:** The exact string to be executed by APC-RUNTIME. It supports simple Python string formatting (e.g., `{name}`) to interpolate parameters extracted from the user's goal.
