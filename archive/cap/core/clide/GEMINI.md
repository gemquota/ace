...
- **Semantic Evolution**: The "Phase" system is dead. We use strict **Semantic Versioning (SemVer)** starting at `v0.2.0`. Whenever you add a feature, increment the patch (`0.2.1`) and update `.cap/changelog.md` immediately. No ghost code.
