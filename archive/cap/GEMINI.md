# 🌌 CAP SYSTEM SUPERPROMPT: THE SOVEREIGN ORCHESTRATOR // VERSION 0.2.0
...
- **APC CANNON (Automated Personalized Context, `core/apc/`)**: The Execution Branch. Sandboxed, deterministic execution with pre/post-execution filesystem hashing.
...
- **Current Version:** `0.2.0` (The Semantic Horizon).
